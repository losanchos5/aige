...
// (`bok-<slug>`) and one per framework comparison (`crosswalk-<slug>`). Built
// at `astro build` time; served at
// /og/<slug>.png. The image content lives in src/lib/og.ts.
import type { APIRoute, GetStaticPaths } from 'astro';
import { renderOg } from '../../lib/og';
import { ogCards } from '../../lib/og-cards';

// One card per top-level route, per chapter and per comparison, titled from lib/og-cards.ts

...
export const figures: readonly FigureDef[] = [
  ...
  },
  {
    ...
    alt: 'First-report deadlines of eight regimes, timed from awareness: DORA at 4 hours after classification to the AI Act and SB 53 at 15 days, in one incident record.',
    description:

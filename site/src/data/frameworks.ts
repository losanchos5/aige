...
export const obligations: readonly Obligation[] = [
  ...
  },
  {
    ...
    anchor: US_FRONTIER_ANCHOR,
    scope:
      'Frontier developers (models trained above 10^26 operations) report incidents within 72 hours; the framework duty binds large frontier developers (annual revenue over USD 500M); thresholds of the chapter amendment signed 2026-03-27',

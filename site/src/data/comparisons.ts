...
//   60 words each, tests/seo-compare.spec.ts counts them) and the FAQ, grounded
//   in the same chapters. No fact here is new to the repository.
//
...
export interface ComparisonDef {
  ...
  answer: string;
  /** "Can you use <A> to comply with <B>?", 40 to 60 words. */
  canUse: string;
...
export const glance: Readonly<Record<string, GlanceFacts>> = {
  ...
  'nist-ai-rmf': {
    type: 'Framework: NIST AI Risk Management Framework 1.0 (NIST AI 100-1), with profiles such as the Generative AI Profile',
    ...
    certifiable: 'No. It is voluntary guidance with no certification of its own.',
    artefacts:
...
export const comparisons: readonly ComparisonDef[] = [
    ...
    faq: [
      {
        ...
        a: 'No. Under Article 40 only harmonised European standards whose references are published in the Official Journal give a presumption of conformity, to the extent they cover the requirements. ISO/IEC 42001 is not one of them. As of 2026-09-24 no harmonised standard had been cited at all.',
      },
      {
  ...
  },
  {
    ...
    bName: 'EU AI Act',
    answer:
      'The EU AI Act is binding law, directly applicable in every Member State; it reaches providers, deployers, importers and distributors whose AI systems are placed on the EU market or whose output is used there. The NIST AI RMF 1.0 is a voluntary, US-origin framework that any organisation may adopt; it has no legal force and no certification.',
    canUse:
      "Not by itself. Under Article 40 only harmonised European standards cited in the Official Journal give a presumption of conformity, and the RMF is voluntary US guidance, not one of them. It is still scaffolding: its four functions organise the risk management, testing and monitoring the Act's high-risk articles require, and one set of evidence can serve both.",
    startWith:

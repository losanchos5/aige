...
field (`public/hero-field.js`, a WebGL shader painting `.hero-canvas` every frame, a blob lap every
~15–30 s so the field reads as alive at a glance) and its figures strip

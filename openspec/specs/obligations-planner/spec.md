# obligations-planner Specification

## Purpose
El planificador de obligaciones y plazos (`/toolkit/obligations-planner`) devuelve, para los roles de la
cadena de valor del AI Act y las clases de sistema que marque el lector, las filas del registro que le
obligan con su fecha y estado, sin reescribir ninguna fecha del registro.

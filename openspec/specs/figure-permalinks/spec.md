# figure-permalinks Specification

## Purpose
Cada infografía de los capítulos se puede enlazar y citar: su pie lleva un ancla `#figure-<id>`
y un enlace a su página en `/figures/<id>`, de modo que la figura y su permalink no se separan.

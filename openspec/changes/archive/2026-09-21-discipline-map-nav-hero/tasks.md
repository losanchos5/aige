...
- [x] 7.4 Archivar la change con `/opsx:archive` y actualizar la memoria de sesión; verificar con `openspec list` que la change ya no está en curso.

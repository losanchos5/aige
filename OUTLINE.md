...
marked **[drafted in v0.1]** exist; the rest are open for co-authors.
...
### 01 — The definition **[drafted in v0.1]**
...
Runtime Controls & Observability · 05 Assurance & Continuous Compliance.** Must stay consistent with
`posts/01-ai-governance-engineering-stack`. Each layer ends with a "Maps to" line feeding chapter 08.
~2,500 words.

### 05 — Patterns (12–15, CSIRO template)
...
that no harmonised standard is yet OJ-cited. **Reuse `posts/02` and `posts/03` sources.md.** ~2,000
words.

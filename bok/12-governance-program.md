...
[1] EU AI Act Art. 17 (quality management system; Art. 17(1)(a) strategy for regulatory compliance; Art. 17(1)(m) accountability framework; Art. 17(2) proportionality). AI Act (Reg. (EU) 2024/1689), as amended. 2024. https://artificialintelligenceact.eu/article/17/ (verified: primary)
...
[6] EU AI Act Art. 26 (deployer obligations: 26(1) use per instructions; 26(2) oversight by persons with competence, training and authority; 26(5) monitoring, informing the provider and suspension; 26(7) informing workers' representatives and affected workers). AI Act (Reg. (EU) 2024/1689). 2024. https://artificialintelligenceact.eu/article/26/ (verified: primary)
...
[8] EU AI Act Art. 4 as amended by the Digital Omnibus (providers and deployers "take measures to support the development of AI literacy"; no guaranteed level for any individual; support from the Commission and Member States; Board recommendations; applies since 2 Feb 2025). AI Act Explorer (Future of Life Institute). 2026. https://artificialintelligenceact.eu/article/4/ (verified: primary)
...
[12] EU AI Act Art. 87 (Directive (EU) 2019/1937 applies to the reporting of infringements of the AI Act and the protection of reporting persons; applies from 2 Aug 2026). AI Act (Reg. (EU) 2024/1689). 2024. https://artificialintelligenceact.eu/article/87/ (verified: primary)
[13] Directive (EU) 2019/1937 on the protection of persons who report breaches of Union law (Art. 8(1) and 8(3) internal channels for private entities with 50 or more workers; Art. 9(1)(b) acknowledgment within seven days; Art. 9(1)(f) feedback within three months; Art. 19 prohibition of retaliation). European Parliament and Council, text as adopted (read via legislation.gov.uk). 2019-10-23. https://www.legislation.gov.uk/eudr/2019/1937 (verified: primary)
[14] SB 53, Transparency in Frontier Artificial Intelligence Act (Chapter 138, Statutes of 2025; Labor Code §§1107–1107.2: "covered employee", no rule preventing disclosure, no retaliation, notice of rights, anonymous internal process for large frontier developers with monthly updates and quarterly sharing with officers and directors). California Legislature. 2025-09-29. https://leginfo.legislature.ca.gov/faces/billTextClient.xhtml?bill_id=202520260SB53 (verified: primary)
[15] "California's SB 53: the first frontier AI law explained" (in force 1 Jan 2026; frontier developers over USD 500M revenue and ~10^26 FLOP; up to USD 1M/violation; AG enforcement). Future of Privacy Forum. 2026. https://fpf.org/blog/californias-sb-53-the-first-frontier-ai-law-explained/ (verified: secondary)
[16] EU AI Act Art. 3(49) (definition of "serious incident"). AI Act (Reg. (EU) 2024/1689). 2024. https://artificialintelligenceact.eu/article/3/ (verified: primary)
...
[18] Directive (EU) 2019/790 on copyright and related rights in the Digital Single Market (Art. 4(1) text-and-data-mining exception; Art. 4(3) reservation by rightholders, by machine-readable means for content online). European Parliament and Council, text as adopted (read via legislation.gov.uk). 2019-04-17. https://www.legislation.gov.uk/eudr/2019/790/article/4 (verified: primary)
[19] EU AI Act Art. 53(1)(c) (GPAI providers' copyright policy, incl. identifying and complying with Art. 4(3) reservations). AI Act (Reg. (EU) 2024/1689). 2024. https://artificialintelligenceact.eu/article/53/ (verified: primary)
...
[23] EU AI Act Art. 25(1) (a value-chain actor becomes the provider when it puts its name or trademark on a high-risk system, makes a substantial modification, or modifies the intended purpose so that the system becomes high-risk). AI Act (Reg. (EU) 2024/1689). 2024. https://artificialintelligenceact.eu/article/25/ (verified: primary)
[24] EU AI Act Annex III, point 4 (employment, workers' management and access to self-employment: recruitment and selection; decisions on work relationships, task allocation, monitoring and evaluation). AI Act (Reg. (EU) 2024/1689). 2024. https://artificialintelligenceact.eu/annex/3/ (verified: primary)

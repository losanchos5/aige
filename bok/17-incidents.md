...
databases, and to facilitate reporting by downstream modifiers, downstream providers and users by
telling them of direct reporting channels, to the provider or to the AI Office, where these are
available [5]. A deployer that only watches its own dashboards will learn about some incidents from
a journalist.
...
| California SB 53 [21] | Frontier developers (all, not only large frontier developers) | Critical safety incident | Within 15 days of discovery; within 24 hours if there is an imminent risk of death or serious physical injury | None set here | Office of Emergency Services; for imminent risk, an appropriate authority |
| New York RAISE Act [22][23] | Frontier developers (models trained above 10^26 operations; all, not only large frontier developers) | Critical safety incident | Within 72 hours of a determination or of learning facts that support a reasonable belief; within 24 hours if there is an imminent risk of death or serious physical injury; effective 1 Jan 2027 | None set here | Oversight office within the Department of Financial Services; for imminent risk, a law enforcement or public safety agency with jurisdiction |
...
DORA's four-hour clock counts from *classification* as major, with an outer limit of 24 hours from
awareness; a classification made after those 24 hours starts its own four-hour clock (`Art. 5(2)` of
RTS 2025/301) [19].
...
- The high-risk regime applies to Annex III systems from 2 Dec 2027 and to Annex I systems from
  2 Aug 2028, after the Digital Omnibus postponed Chapter III, Sections 1 to 3 (`Art. 113(c)`) [34].
  `Art. 73` sits in Chapter IX and was not itself postponed, but it reaches a system only once
  `Art. 6` classifies it as high-risk, so in practice it follows the same dates (verify with
  counsel); the GPAI duties in `Art. 55` already apply (see
  [chapter 08](/bok/regulatory-map#eu-ai-act-post-omnibus)).

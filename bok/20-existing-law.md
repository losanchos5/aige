...
> **In short**
> The AI Act is the newest law governing AI systems, not the only one: intellectual property,
...
> AI Act Article 53(1)(c) requires GPAI providers to keep a copyright policy that honours those
> reservations [3][4]. The revised Product Liability Directive, (EU) 2024/2853, treats software as a
> product and must be transposed by 9 Dec 2026 [2]. Each duty maps to evidence and a stack layer.
...
specific reasons, or a notice of the right to receive them [50]. The CFPB's Circular 2022-03 said in
2022 that creditors using complex algorithms, including AI or machine learning, must still provide
the specific principal reasons [51]; the CFPB withdrew the circular on 12 May 2025 [84], but the
Regulation B duty is unchanged [50][83]. Where the decision rests on a consumer

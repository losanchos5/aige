...
high-impact definition that covers digital medical devices started on 24 Jan 2026, and Article 2
was amended on 20 Jan 2026 before entry into force [1]. The Enforcement Decree, Presidential Decree
No. 36053, was promulgated on 21 Jan 2026 and took effect on 22 Jan 2026 [2]. MSIT, the competent
ministry, announced a guidance period of at least one year during which fact-finding
investigations and administrative fines are suspended except in very exceptional cases, such as
loss of life or human-rights violations [3]. The grace period is on the fines, not on the duties:
the obligations have applied since 22 Jan 2026. A decree amendment that took effect on 21 Jul 2026
added a confirmation system for AI products in public procurement and a liability exemption for
officials who adopt AI, without touching the operator duties described below, as reported by the
Korean trade press [4].
...
to be affected; the fundamental rights at stake; the social and economic effects; the patterns of
...
- In the courts, the US Department of Justice intervened in a developer's suit against Colorado's
  original AI Act, arguing that it violates the Equal Protection Clause [17].
...
| New York RAISE Act | Signed 2025-12-19; effective 2027-01-01 after the 2026 chapter amendment [25][26] | Large frontier developers (the protocol); every frontier developer (incident reports) [26] | Published safety protocol; safety incidents disclosed within 72 hours; DFS oversight office | Attorney General [25] | Published protocol; 72-hour incident pipeline | 4 · 5 |
...
- **The bill.** The Council of Ministers approved, at first reading on 11 Mar 2025, the draft bill
  ...
  and allocates supervision: the data-protection agency for biometric and border systems, the
  judiciary's council for justice, the central electoral board for democratic processes, the Bank of
  Spain, the insurance directorate and CNMV for their sectors, and AESIA for the rest [47]. It had
...
- **The guides.** AESIA publishes 16 guides produced in the sandbox pilot: two introductory guides,
  ...
  non-binding, and AESIA says they will be updated once the Digital Omnibus amending the AI Act is
  final [49].
...
| ECOA and Regulation B; FCRA adverse-action notices [64] | A credit decision made or supported by a complex algorithm | Specific principal reasons for adverse action; the CFPB's 2022 circular saying complexity is no excuse was withdrawn on 12 May 2025, and the Regulation B duty stands [68]. FCRA notices apply where a consumer report is used (verify scope per product) | Reason-code generator logged with each decision; notice template; eval that reasons are faithful to the model | 3 · 4 · 5 |
| Platform Work Directive, Dir. (EU) 2024/2831 (transposition within two years; 2 Dec 2026, verify) [65] | Digital labour platforms using automated monitoring or decision-making | Transparency of automated systems; monitoring by qualified staff; a right to contest automated decisions | Algorithmic-management register; worker-facing information; human-review queue with decision log; DPIA | 2 · 4 · 5 |
...
| DORA [55] | Major ICT-related incident | Timelines set in the supervisory technical standards (verify the hours) | Competent financial authority |
...
| New York RAISE [25] | Safety incident | 72 h | State oversight |
...
[4] "AI기본법 시행령 7월 시행, 공공조달 AI 확인 제도 핵심 정리" (decree amendment in force 2026-07-21: public-procurement AI confirmation system, liability exemption for adopting officials, support measures). Korea Data Economy News (한국데이터경제신문). 2026-07-20. https://www.dataeconomy.co.kr/news/articleView.html?idxno=41346 (verified: secondary)
...
[16] "Colorado AI law in flux: comprehensive replacement bill signed after federal court blocks predecessor's enforcement" (SB 24-205 delayed to 2026-06-30, then replaced by SB 26-189). McDermott Will & Emery. 2026. https://www.mcdermottlaw.com/insights/colorado-ai-law-in-flux-comprehensive-replacement-bill-signed-after-federal-court-blocks-predecessors-enforcement/ (verified: secondary)
...
[25] NY State Senate Bill 2025-S6953B (RAISE Act; signed 2025-12-19; frontier models above 10^26 operations and USD 100M; safety protocols; 72-hour incident disclosure; superseded in scope by the 2026 chapter amendment, which drops the cost test and adds a USD 500M revenue test [26]). New York State Senate. 2025-12-19. https://www.nysenate.gov/legislation/bills/2025/S6953/amendment/B (verified: primary)
[26] "New York Finalizes RAISE Act for Frontier AI Models; Law Takes Effect January 1, 2027" (chapter amendment signed 2026-03-27; frontier model above 10^26 operations, large frontier developer above USD 500M annual revenue; DFS oversight office). Wiley. 2026. https://www.wiley.law/alert-New-York-Finalizes-RAISE-Act-for-Frontier-AI-Models-Law-Takes-Effect-January-1-2027 (verified: secondary)
...
[49] Guías (16 guides from the Spanish AI regulatory sandbox pilot; non-binding; to be updated after the Digital Omnibus). AESIA. 2026. https://aesia.digital.gob.es/es/guias (verified: primary)
...
[64] Consumer Financial Protection Circular 2022-03, Adverse action notification requirements in connection with credit decisions based on complex algorithms (ECOA and Regulation B; the page shows no withdrawal notice, but the circular was withdrawn on 12 May 2025, see [68]). Consumer Financial Protection Bureau. 2022-05-26. https://www.consumerfinance.gov/compliance/circulars/circular-2022-03-adverse-action-notification-requirements-in-connection-with-credit-decisions-based-on-complex-algorithms/ (verified: primary)

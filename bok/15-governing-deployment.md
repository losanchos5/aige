...
[8] Consolidated changes after the Digital Omnibus (Art. 4 replaced: providers and deployers support AI literacy; Art. 25(2) cooperation extended to technical documentation, known limitations and failure modes and targeted technical access; Art. 25(4) revised; Art. 26 unchanged). AI Act Explorer (Future of Life Institute). 2026. https://artificialintelligenceact.eu/ai-act-explorer/digital-omnibus/ (verified: secondary)
...
[43] GDPR Art. 33 (notification of a personal data breach to the supervisory authority without undue delay and, where feasible, within 72 hours). gdpr-info.eu (Reg. (EU) 2016/679). 2016. https://gdpr-info.eu/art-33-gdpr/ (verified: secondary)
[44] GDPR Art. 34(1) (communication of a breach likely to result in a high risk to the data subject without undue delay). gdpr-info.eu (Reg. (EU) 2016/679). 2016. https://gdpr-info.eu/art-34-gdpr/ (verified: secondary)

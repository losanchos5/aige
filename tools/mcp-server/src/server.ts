...
export const INSTRUCTIONS = [
  ...
  'the glossary, the governance patterns, the templates-and-schemas library and the Body of Knowledge chapters.',
  ...
  'a control, list_templates / get_template for record formats, and search_bok to find where the book treats a subject.',
